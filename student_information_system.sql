...
--
-- Host: localhost:3306
-- Generation Time: Jan 24, 2023 at 07:41 PM
...
CREATE TABLE `labqueues` (
  `id` bigint UNSIGNED NOT NULL,
  `labreport_id` bigint UNSIGNED NOT NULL,
...
(22, 'Lab one Request Doctor', 'Lab one Request Doctor', 2, 2, '2023-01-24 16:29:19', '2023-01-24 16:29:19', 0);
...
(6, 'Lab one Request Lab', 'Lab one Request Lab', 'Lab one Request Lab', 22, 3, 2, '2023-01-24 16:33:50', '2023-01-24 16:33:50', 0);
...
(18, 2, 2, NULL, NULL, '2023-01-24 16:27:39', '2023-01-24 16:27:39');
...
(25, '2023_01_24_091633_create_roles_table', 22),
(26, '2023_01_24_115519_add_role_id_to_table_users', 23);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `campas_id`, `clinic_id`, `remember_token`, `created_at`, `updated_at`, `role_id`) VALUES
(1, 'Abraham Sisay', 'Abrahamsisaysis@gmail.com', NULL, '$2y$10$mQzvXY9a2pzGfkzQywKYMeM3IVuudwfBUtSNgXSKi8ZjjC8hY6hZ2', 1, 1, NULL, '2023-01-20 21:49:00', '2023-01-20 21:49:00', 1),
(2, 'Doctor 1', 'doctor@one.com', NULL, '$2y$10$mQzvXY9a2pzGfkzQywKYMeM3IVuudwfBUtSNgXSKi8ZjjC8hY6hZ2', 1, 1, NULL, NULL, NULL, 2),
(3, 'Lab 1', 'lab@one.com', NULL, '$2y$10$mQzvXY9a2pzGfkzQywKYMeM3IVuudwfBUtSNgXSKi8ZjjC8hY6hZ2', 1, 1, NULL, NULL, NULL, 3),
(4, 'receptionist', 'receptionist@one.com', NULL, '$2y$10$NuytOKsza308oZmNgTnwiOacX/9QlAk8owkt2mtNt3uFJmjj7fpGi', 1, 1, NULL, '2023-01-22 14:26:24', '2023-01-22 14:26:24', 4);
